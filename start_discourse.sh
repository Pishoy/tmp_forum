...
for var in DISCOURSE_VERSION RAILS_ENV DISCOURSE_HOSTNAME DISCOURSE_SMTP_USER_NAME DISCOURSE_SMTP_ADDRESS DISCOURSE_DEVELOPER_EMAILS DISCOURSE_SMTP_PORT THREEBOT_PRIVATE_KEY FALSK_SECRET_KEY THREEBOT_URL OPEN_KYC_URL 
    do
        if [ -z "${!var}" ]
        then
